...
export default function LiquidLetter() {
  const v = useDialKit("Liquid letter", {
    ...
    width: [150, 80, 1200, 10],
    height: [62, 40, 800, 10],
    BG: { type: "color", default: "#4a74f1" },
    Y_offset: [0, -200, 200, 1],
    fontSize: [37.5, 10, 400, 0.5],
    maskPad: [7.5, 0, 200, 0.5],
    fontWeight: [500, 100, 900, 100],
    borderRadius: [50, 0, 400, 1],
    hueRotate_01: [540, 0, 720, 1],
    hueRotate_02: [260, 0, 720, 1],
    noise: [0.2, 0, 1, 0.01],
    blur_01: [3, 0, 40, 0.1],
    blur_02: [1.05, 0, 40, 0.1],
    innerShadow: [7.5, 0, 100, 0.5],
    innerShadowSpread: [3.75, 0, 100, 0.25],
